...
const Cover = ({ coverImg, title, details }) => {
    return (
        <div className="relative text-center">
            <img src={coverImg} alt="" className='w-full h-[450px] rounded-md' />
            <div className='absolute inset-0 flex flex-col items-center justify-center my-8 lg:my-32 bg-black bg-opacity-60 p-6 mx-auto w-4/5 rounded-lg shadow-lg'>
